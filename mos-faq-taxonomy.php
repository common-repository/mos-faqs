<?php
// hook into the init action and call mos_faq_taxonomies when it fires
add_action( 'init', 'mos_faq_taxonomies', 0 );

// create two taxonomies, categories and tags for the post type "faq"
function mos_faq_taxonomies() {
	...
	register_taxonomy( 'faq-tag', 'qa', $args );
}